package com.example.cinebox.presentation.search.adapter
...
import com.example.cinebox.databinding.ItemRowListBinding
import com.example.cinebox.presentation.home.adapter.MovieDiffCallback

class SearchAdapter(private val onItemClickCallback: OnItemClickCallback): PagingDataAdapter<Movie, SearchAdapter.SearchViewModel>(MovieDiffCallback) {
