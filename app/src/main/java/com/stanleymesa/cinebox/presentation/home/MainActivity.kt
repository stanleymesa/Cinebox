...
import com.stanleymesa.cinebox.R
import com.stanleymesa.cinebox.databinding.ActivityMainBinding
import com.stanleymesa.cinebox.presentation.detail.DetailActivity
import com.stanleymesa.cinebox.presentation.search.SearchActivity
import com.stanleymesa.core.ui.home.MovieAdapter
import com.stanleymesa.core.utils.*
...
class MainActivity : AppCompatActivity(), MovieAdapter.OnItemClickCallback, View.OnClickListener {
    ...
    private fun observeData() {
        ...
        homeViewModel.nowPlayingMovie.observe(this) { event ->
            event.getContentIfNotHandled()?.let {
        ...
        homeViewModel.upcomingMovie.observe(this) { event ->
            event.getContentIfNotHandled()?.let {
        ...
        homeViewModel.topRatedMovie.observe(this) { event ->
            event.getContentIfNotHandled()?.let {
    ...
    private fun setSkeleton() {
        ...
        with(binding.content) {
            rvNowPlayingSkeleton =
                rvNowPlaying.applySkeleton(com.stanleymesa.core.R.layout.item_row_movie)
            rvUpcomingSkeleton = rvUpcoming.applySkeleton(com.stanleymesa.core.R.layout.item_row_movie)
            rvTopRatedSkeleton = rvToprated.applySkeleton(com.stanleymesa.core.R.layout.item_row_movie)
        }
    ...
    private fun moveToFavourite() {
        startActivity(Intent(applicationContext, Class.forName("com.stanleymesa.favourite.FavouriteActivity")))
    }
